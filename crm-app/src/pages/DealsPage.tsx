  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto pb-4" data-component="deal-pipeline">
            ...
            {STAGES.map((stage) => {
              ...
              return (
                <div key={stage} className="flex-shrink-0 w-80">
                  <div className="bg-surface rounded-lg p-4 shadow-card border border-neutral-200 dark:border-neutral-dark-700" data-component="deal-stage-column">
                    <div className="mb-4">
